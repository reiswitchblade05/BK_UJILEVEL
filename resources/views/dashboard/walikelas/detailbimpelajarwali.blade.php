                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ url('bimpelajarwali') }}"><i class=" fas fa-seedling" style="padding-right: 3px;"></i>Bimbingan Pelajar</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Detail Bimbingan Pelajar</h5>
                                    <div class="card-body">
                                        <form action="#" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" value="{{ $data->tema }}" name="tema" placeholder="Tema Konseling" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" disabled>
                                            </div>
                                            ...
                                            <button class="btn-back"><a href="{{ url('bimpelajarwali') }}" style="color: #fff;">Kembali</a></button>
                                        </form>
                                    </div>
                                </div>
                            </div>

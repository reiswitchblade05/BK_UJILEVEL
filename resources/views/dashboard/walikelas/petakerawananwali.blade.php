                    ...
                    <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    ...
                                    @endif
                                    <div class="card-body">
                                        <button class="btn-tambah" style="margin-right: 15px;"><a href="{{ url('tambahpetakerawananwali') }}" style="color: #fff;">Tambah</a></button> <button class="btn-tambah"><a href="/exportpdfwali" style="color: #fff;">Export PDF</a></button> <button class="btn-tambah"><a href="/exportexcelwali" style="color: #fff;">Export Excel</a></button>
                                            ...
                                            <table class="table table-striped table-bordered first">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn-edit"><a href="/editpetakerawananwali/{{ $row->id }}" style="color: #fff;">Edit</a></button>
                                                            <button class="btn-delete"><a href="/hapuspetakerawananwali/{{ $row->id }}" style="color: #fff;">Delete</a></button>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>

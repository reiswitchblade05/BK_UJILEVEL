                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="{{ url('petakerawanan') }}"><i class="fas fa-align-left" style="padding-right: 5px;"></i>Peta Kerawanan</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Peta Kerawanan </h2>
                                <p class="pageheader-text">Nulla euismod urna eros, sit amet scelerisque torton lectus vel mauris facilisis faucibus at enim quis massa lobortis rutrum.</p>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Guru BK</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Peta Kerawanan</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form action="/updatepetakerawanan/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <button type="submit" class="btn-edit">Update Data</button> <button class="btn-back"><a href="{{ url('petakerawanan') }}" style="color: #fff;">Kembali</a></button>
                                            </form>
                                        </div>
                                    </div>
                                </div>

                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Update Bimbingan Karir</h5>
                                    <div class="card-body">
                                        <form action="/updatebimkarir/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <input name="jadwal_bimbingan" value="{{ $data->jadwal_bimbingan }}" placeholder="Jadwal Konseling" class="textbox-n" type="text" onfocus="(this.type='datetime-local')" id="datetime-local" style="width: 100%; padding: 5px; padding-left: 10px;">
                                            <input name="jadwal_sosialisasi" value="{{ $data->jadwal_sosialisasi }}" placeholder="Jadwal Sosialisasi" class="textbox-n mt-3" type="text" onfocus="(this.type='datetime-local')" id="datetime-local" style="width: 100%; padding: 5px; padding-left: 10px;">
                                            <div class="input-group mb-3 mt-3">
                                                <input type="text" name="karir" value="{{ $data->karir }}" placeholder="Cita-Cita" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" disabled>
                                            </div>

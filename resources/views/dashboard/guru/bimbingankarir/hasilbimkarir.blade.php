            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Insert Hasil Bimbingan Karir</h5>
                                    <div class="card-body">
                                    <form action="/inserthasilkarir/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <button type="submit" class="btn-tambah">Tambah Data</button> <button class="btn-back"><a href="{{ url('bimbingankarir') }}" style="color: #fff;">Kembali</a></button>
                                    </form>
                                    </div>
                                </div>
                            </div>

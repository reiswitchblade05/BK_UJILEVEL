                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ url('insertbimkarir') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <input name="jadwal_sosialisasi" placeholder="Jadwal Sosialisasi" class="textbox-n mt-3" type="text" onfocus="(this.type='datetime-local')" id="datetime-local" style="width: 100%; padding: 5px; padding-left: 10px;">
                                            ...
                                            <button type="submit" class="btn-tambah">Tambah Data</button> <button class="btn-back"><a href="{{ url('bimkarir') }}" style="color: #fff;">Kembali</a></button>
                                        </form>
                                    </div>
                                </div>
                            </div>

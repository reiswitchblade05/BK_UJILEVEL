                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    ...
                                    <form action="/updatebimpribadi/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" value="{{ $data->nipd }}" name="nipd" placeholder="NIPD" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
                                        </div>
                                        <div class="input-group mb-3">
                                        ...
                                        <input name="jadwal_konseling" value="{{ $data->jadwal_konseling }}" placeholder="Jadwal Konseling" class="textbox-n" type="text" onfocus="(this.type='datetime-local')" id="datetime-local" style="width: 100%; padding: 5px; padding-left: 10px;">
                                        <select name="status" value="{{ $data->status }}" class="form-select w-100 p-2 mb-3 mt-3" aria-label="Default select example">

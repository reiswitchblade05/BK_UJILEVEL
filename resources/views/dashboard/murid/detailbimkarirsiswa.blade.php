                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ url('bimkarirsiswa') }}"><i class="fas fa-fw fa-chart-pie"></i>Bimbingan Karir</a>
                            </li>
                            <li class="nav-item">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="#" method="POST" enctype="multipart/form-data">
                                            ...
                                            <button class="btn-back"><a href="{{ url('bimkarirsiswa') }}" style="color: #fff;">Kembali</a></button>
                                        </form>
                                    </div>
                                </div>
                            </div>

                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                    <form action="{{ url('insertmurid') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" name="nisn" placeholder="NISN" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
                                        </div>
                                        <input name="tanggal_lahir" placeholder="Tanggal Lahir" class="textbox-n" type="text" onfocus="(this.type='date')" id="date" style="width: 100%; padding: 5px; padding-left: 10px;">
                                        ...
                                        <button type="submit" class="btn-tambah">Tambah Data</button> <button class="btn-back"><a href="{{ url('muridadmin') }}" style="color: #fff;">Kembali</a></button>
                                    </form>
                                    </div>
                                </div>
                            </div>

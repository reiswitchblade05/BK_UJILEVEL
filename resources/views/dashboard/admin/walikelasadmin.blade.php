                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    ...
                                    @endif
                                    <div class="card-body">
                                        <button class="btn-tambah"> <a href="{{ url('tambahwalikelas') }}" style="color: #fff;">Tambah</a> </button>
                                            ...
                                            <table class="table table-striped table-bordered first">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn-edit"><a href="/editwalikelas/{{ $row->id }}" style="color: #fff;">Edit</a></button>
                                                            <button class="btn-delete"><a href="/hapuswalikelas/{{ $row->id }}" style="color: #fff;">Delete</a></button>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>

            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Tabel Jenis Kerawanan</h5>
                                    ...
                                    @endif
                                    <div class="card-body">
                                        <button class="btn-tambah"> <a href="{{ url('tambahjeniskerawanan') }}" style="color: #fff;">Tambah</a> </button>
                                            ...
                                            <table class="table table-striped table-bordered first">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn-delete"><a href="/hapusjeniskerawanan/{{ $row->id }}" style="color: #fff;">Delete</a></button>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>

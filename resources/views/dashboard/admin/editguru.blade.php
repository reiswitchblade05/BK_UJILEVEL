                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="/updateguru/{{ $row->id }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" value="{{ $row->password }}" name="password" placeholder="Password" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
                                            </div>
                                            <button type="submit" class="btn-tambah">Update Data</button> <button class="btn-back"><a href="{{ url('guruadmin') }}" style="color: #fff;">Kembali</a></button>
                                        </form>
                                    </div>
                                </div>
                            </div>
